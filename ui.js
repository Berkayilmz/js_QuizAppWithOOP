function UI(){
    ...
    this.btn_replay=document.querySelector(".score_box .buttons .btn_replay"),
    this.btn_quit=document.querySelector(".score_box .buttons .btn_quit")
}
...
UI.prototype.tekrarBaslat=function(){
